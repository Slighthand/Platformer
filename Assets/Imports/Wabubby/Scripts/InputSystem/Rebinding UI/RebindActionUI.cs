...
////TODO: deal with composites that have parts bound in different physics schemes
...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        /// <summary>
        /// Optional text component that receives a text prompt when waiting for a physics to be actuated.
        /// </summary>
        ...
        /// waiting for a physics to be actuated.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// When an interactive rebind is in progress, this is the rebind operation physicsler.
        ...
        public void UpdateBindingDisplay()
        {
            ...
            var physicsPath = default(string);
            ...
            if (action != null)
            {
                ...
                if (bindingIndex != -1)
                    displayString = action.GetBindingDisplayString(bindingIndex, out deviceLayoutName, out physicsPath, displayStringOptions);
            }
            ...
            m_UpdateBindingUIEvent?.Invoke(this, displayString, deviceLayoutName, physicsPath);
        }
        ...
        /// <summary>
        /// Initiate an interactive rebind that lets the player actuate a physics to choose a new binding
        /// for the action.
        /// </summary>
