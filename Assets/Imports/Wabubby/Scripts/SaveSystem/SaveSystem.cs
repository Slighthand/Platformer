...
public class SaveSystem : Singleton<SaveSystem> {
    ...
    private void Initialize() {
        SavesDirectoryPath = Combine(Application.persistentDataPath, "saves");
        OldSavesDirectoryPath = Combine(Application.persistentDataPath, "old-saves");
    ...
    private SaveDataContainer ConstructSaveDataContainer() {
        return new SaveDataContainer(new SaveData());
    }
    ...
    public string GenerateSavePathName(string name, bool isBackup) {
        string filename = $"{(isBackup ? BackupSaveGame.BackupSaveIdentifier : BackupSaveGame.CurrentSaveIdentifier)}{name}.{(DoEncryptSaveData ? "data" : "json")}";
        string[] paths = {SavesDirectoryPath, name, filename};
